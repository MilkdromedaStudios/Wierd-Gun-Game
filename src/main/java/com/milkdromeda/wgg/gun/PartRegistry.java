...
public final class PartRegistry {
    ...
    private static void registerBarrels() {
        add("snubnose", PartSection.BARREL, "Snubnose Stub", Material.IRON_NUGGET, Rarity.COMMON,
        ...
        add("long_rifled", PartSection.BARREL, "Long Rifled Barrel", Material.BLAZE_ROD, Rarity.UNCOMMON,
        ...
        add("boomstick", PartSection.BARREL, "Boomstick Bore", Material.BLAST_FURNACE, Rarity.UNCOMMON,
        ...
        add("rpg_tube", PartSection.BARREL, "RPG Launch Tube", Material.TNT_MINECART, Rarity.EXOTIC,
        ...
        add("gatling", PartSection.BARREL, "Gatling Cluster", Material.IRON_BARS, Rarity.RARE,
        ...
        add("noodle", PartSection.BARREL, "Wet Noodle Barrel", Material.DRIED_KELP, Rarity.CURSED,
        ...
        add("tesla_rod", PartSection.BARREL, "Tesla Rod", Material.LIGHTNING_ROD, Rarity.RARE,
                "Grounded, allegedly.",
        ...
        add("frostbite", PartSection.BARREL, "Frostbite Pipe", Material.PACKED_ICE, Rarity.RARE,
        ...
        add("cursed_bone", PartSection.BARREL, "Cursed Bone Barrel", Material.BONE, Rarity.CURSED,
        ...
        add("singularity", PartSection.BARREL, "Singularity Muzzle", Material.CRYING_OBSIDIAN, Rarity.EXOTIC,
    ...
    private static void registerCores() {
        add("iron_core", PartSection.CORE, "Iron Core", Material.IRON_INGOT, Rarity.COMMON,
        ...
        add("redstone_reactor", PartSection.CORE, "Redstone Reactor", Material.REDSTONE_BLOCK, Rarity.UNCOMMON,
        ...
        add("blaze_heart", PartSection.CORE, "Blaze Heart", Material.BLAZE_POWDER, Rarity.RARE,
        ...
        add("ender_core", PartSection.CORE, "Ender Core", Material.ENDER_PEARL, Rarity.RARE,
        ...
        add("tnt_core", PartSection.CORE, "TNT Core", Material.TNT, Rarity.EXOTIC,
        ...
        add("amethyst_resonator", PartSection.CORE, "Amethyst Resonator", Material.AMETHYST_SHARD, Rarity.RARE,
        ...
        add("slime_core", PartSection.CORE, "Slime Core", Material.SLIME_BALL, Rarity.UNCOMMON,
        ...
        add("nether_star_core", PartSection.CORE, "Nether Star Core", Material.NETHER_STAR, Rarity.EXOTIC,
        ...
        add("goat_horn_core", PartSection.CORE, "Goat Horn Core", Material.GOAT_HORN, Rarity.RARE,
        ...
        add("chicken_core", PartSection.CORE, "Chicken Core", Material.EGG, Rarity.CURSED,
    ...
    private static void registerGrips() {
        add("duct_tape", PartSection.GRIP, "Duct Tape Grip", Material.STRING, Rarity.COMMON,
        ...
        add("rubber_grip", PartSection.GRIP, "Ergonomic Rubber Grip", Material.LEATHER, Rarity.COMMON,
                "Comfortable. Boring. Genuinely fine.",
                List.of("Tighter spread", "Less recoil"),
                s -> s.spread(-1.5).recoil(-0.1).reload(-4));

        add("bipod", PartSection.GRIP, "Bipod Grip", Material.TRIPWIRE_HOOK, Rarity.UNCOMMON,
        ...
        add("angled_foregrip", PartSection.GRIP, "Angled Foregrip", Material.STICK, Rarity.UNCOMMON,
        ...
        add("vertical_foregrip", PartSection.GRIP, "Vertical Foregrip", Material.BLAZE_ROD, Rarity.UNCOMMON,
                "Straight up and down, like your aim now is.",
                List.of("Big recoil reduction", "Tight spread"),
                s -> s.recoil(-0.25).spread(-1.8).damage(0.5));

        add("honey_grip", PartSection.GRIP, "Honey Grip", Material.HONEY_BLOCK, Rarity.RARE,
        ...
        add("rocket_grip", PartSection.GRIP, "Rocket Grip", Material.FIREWORK_ROCKET, Rarity.EXOTIC,
        ...
        add("squid_grip", PartSection.GRIP, "Squid Grip", Material.INK_SAC, Rarity.CURSED,
        ...
        add("golden_grip", PartSection.GRIP, "Golden Grip", Material.GOLD_INGOT, Rarity.RARE,
        ...
        add("skeleton_hand", PartSection.GRIP, "Skeleton Hand Grip", Material.SKELETON_SKULL, Rarity.CURSED,
    ...
    private static void registerMagazines() {
        add("stick_mag", PartSection.MAGAZINE, "Stick Mag", Material.IRON_NUGGET, Rarity.COMMON,
                "Eight rounds. Count them. You will need to.",
                List.of("8 rounds", "Very fast reload", "Extra damage"),
                s -> s.mag(-4).reload(-12).damage(1.0));

        add("extended_mag", PartSection.MAGAZINE, "Extended Mag", Material.IRON_INGOT, Rarity.UNCOMMON,
                "Sticks out awkwardly. Worth it.",
                List.of("+18 rounds", "Slightly slower reload"),
                s -> s.mag(18).reload(6));

        add("drum_mag", PartSection.MAGAZINE, "Drum Mag", Material.CAULDRON, Rarity.RARE,
        ...
        add("rocket_rack", PartSection.MAGAZINE, "Rocket Rack", Material.FIREWORK_STAR, Rarity.EXOTIC,
        ...
        add("shell_box", PartSection.MAGAZINE, "Shell Box", Material.BARREL, Rarity.UNCOMMON,
        ...
        add("bottomless_satchel", PartSection.MAGAZINE, "Bottomless Satchel", Material.BUNDLE, Rarity.CURSED,
        ...
        add("nuke_mag", PartSection.MAGAZINE, "Nuke Mag", Material.WITHER_SKELETON_SKULL, Rarity.EXOTIC,
        ...
        add("hopper_feed", PartSection.MAGAZINE, "Hopper Feed", Material.HOPPER, Rarity.RARE,
        ...
        add("soul_jar", PartSection.MAGAZINE, "Soul Jar Mag", Material.SOUL_LANTERN, Rarity.CURSED,
    ...
    private static void registerSights() {
        add("iron_sights", PartSection.SIGHT, "Iron Sights", Material.IRON_BARS, Rarity.COMMON,
                "A notch and a bump. It has worked for centuries.",
                List.of("Small accuracy bump", "No downsides"),
                s -> s.spread(-0.8));

        add("red_dot", PartSection.SIGHT, "Red Dot", Material.REDSTONE_TORCH, Rarity.COMMON,
                "Put the dot on the thing. Remove the thing.",
                List.of("Better accuracy", "Slight zoom"),
                s -> s.spread(-1.6).zoom(1));

        add("holo", PartSection.SIGHT, "Holographic Sight", Material.GLASS_PANE, Rarity.UNCOMMON,
                "A floating rectangle of pure confidence.",
                List.of("Good accuracy", "Faster handling"),
                s -> s.spread(-2.2).zoom(1).fireRate(-0.5));

        add("sniper_scope", PartSection.SIGHT, "Sniper Scope", Material.SPYGLASS, Rarity.RARE,
        ...
        add("thermal", PartSection.SIGHT, "Thermal Scope", Material.MAGMA_CREAM, Rarity.RARE,
        ...
        add("laser_pointer", PartSection.SIGHT, "Laser Pointer", Material.END_ROD, Rarity.UNCOMMON,
        ...
        add("googly_eyes", PartSection.SIGHT, "Googly Eyes", Material.SNOWBALL, Rarity.CURSED,
        ...
        add("seeker_eye", PartSection.SIGHT, "Eye of the Seeker", Material.ENDER_EYE, Rarity.EXOTIC,
        ...
        add("cracked_monocle", PartSection.SIGHT, "Cracked Monocle", Material.GLASS, Rarity.CURSED,
        ...
        add("target_computer", PartSection.SIGHT, "Target Computer", Material.OBSERVER, Rarity.EXOTIC,
    ...
    private static void registerStocks() {
        add("wooden_stock", PartSection.STOCK, "Wooden Stock", Material.OAK_PLANKS, Rarity.COMMON,
                "Whittled by someone who had time.",
                List.of("Balanced all round"),
                s -> s.spread(-0.8).recoil(-0.1).reload(-2));

        add("tactical_stock", PartSection.STOCK, "Tactical Stock", Material.NETHERITE_SCRAP, Rarity.UNCOMMON,
        ...
        add("anvil_stock", PartSection.STOCK, "Heavy Anvil Stock", Material.ANVIL, Rarity.RARE,
        ...
        add("skeleton_stock", PartSection.STOCK, "Skeleton Stock", Material.BONE_BLOCK, Rarity.UNCOMMON,
        ...
        add("slime_pad", PartSection.STOCK, "Slime Pad Stock", Material.SLIME_BLOCK, Rarity.RARE,
        ...
        add("booster_stock", PartSection.STOCK, "Rocket Booster Stock", Material.FIRE_CHARGE, Rarity.EXOTIC,
        ...
        add("cactus_stock", PartSection.STOCK, "Cactus Stock", Material.CACTUS, Rarity.CURSED,
        ...
        add("cushion_stock", PartSection.STOCK, "Cushion Stock", Material.WHITE_WOOL, Rarity.RARE,
        ...
        add("jukebox_stock", PartSection.STOCK, "Jukebox Stock", Material.JUKEBOX, Rarity.EXOTIC,
        ...
        add("void_stock", PartSection.STOCK, "Void Stock", Material.OBSIDIAN, Rarity.CURSED,
    ...
    private static void add(String id, PartSection section, String name, Material icon, Rarity rarity,
