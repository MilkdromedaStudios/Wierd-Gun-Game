...
public final class PartRegistry {
    ...
    private static void registerBarrels() {
        add("snubnose", PartSection.BARREL, "Snubnose Stub", "minecraft:iron_nugget", Rarity.COMMON,
        ...
        add("long_rifled", PartSection.BARREL, "Long Rifled Barrel", "minecraft:blaze_rod", Rarity.UNCOMMON,
        ...
        add("boomstick", PartSection.BARREL, "Boomstick Bore", "minecraft:blast_furnace", Rarity.UNCOMMON,
        ...
        add("rpg_tube", PartSection.BARREL, "RPG Launch Tube", "minecraft:tnt_minecart", Rarity.EXOTIC,
        ...
        add("gatling", PartSection.BARREL, "Gatling Cluster", "minecraft:iron_bars", Rarity.RARE,
        ...
        add("noodle", PartSection.BARREL, "Wet Noodle Barrel", "minecraft:dried_kelp", Rarity.CURSED,
        ...
        add("tesla_rod", PartSection.BARREL, "Tesla Rod", "minecraft:lightning_rod", Rarity.RARE,
                "Grounded, allegedly.",
        ...
        add("frostbite", PartSection.BARREL, "Frostbite Pipe", "minecraft:packed_ice", Rarity.RARE,
        ...
        add("cursed_bone", PartSection.BARREL, "Cursed Bone Barrel", "minecraft:bone", Rarity.CURSED,
        ...
        add("singularity", PartSection.BARREL, "Singularity Muzzle", "minecraft:crying_obsidian", Rarity.EXOTIC,
    ...
    private static void registerCores() {
        add("iron_core", PartSection.CORE, "Iron Core", "minecraft:iron_ingot", Rarity.COMMON,
        ...
        add("redstone_reactor", PartSection.CORE, "Redstone Reactor", "minecraft:redstone_block", Rarity.UNCOMMON,
        ...
        add("blaze_heart", PartSection.CORE, "Blaze Heart", "minecraft:blaze_powder", Rarity.RARE,
        ...
        add("ender_core", PartSection.CORE, "Ender Core", "minecraft:ender_pearl", Rarity.RARE,
        ...
        add("tnt_core", PartSection.CORE, "TNT Core", "minecraft:tnt", Rarity.EXOTIC,
        ...
        add("amethyst_resonator", PartSection.CORE, "Amethyst Resonator", "minecraft:amethyst_shard", Rarity.RARE,
        ...
        add("slime_core", PartSection.CORE, "Slime Core", "minecraft:slime_ball", Rarity.UNCOMMON,
        ...
        add("nether_star_core", PartSection.CORE, "Nether Star Core", "minecraft:nether_star", Rarity.EXOTIC,
        ...
        add("goat_horn_core", PartSection.CORE, "Goat Horn Core", "minecraft:goat_horn", Rarity.RARE,
        ...
        add("chicken_core", PartSection.CORE, "Chicken Core", "minecraft:egg", Rarity.CURSED,
    ...
    private static void registerGrips() {
        add("duct_tape", PartSection.GRIP, "Duct Tape Grip", "minecraft:string", Rarity.COMMON,
        ...
        add("rubber_grip", PartSection.GRIP, "Ergonomic Rubber Grip", "minecraft:leather", Rarity.COMMON,
                "Comfortable. Boring. Genuinely fine.",
                List.of("Tighter spread", "Less recoil"),
                s -> s.spread(-1.5).recoil(-0.1).reload(-4));

        add("bipod", PartSection.GRIP, "Bipod Grip", "minecraft:tripwire_hook", Rarity.UNCOMMON,
        ...
        add("angled_foregrip", PartSection.GRIP, "Angled Foregrip", "minecraft:stick", Rarity.UNCOMMON,
        ...
        add("vertical_foregrip", PartSection.GRIP, "Vertical Foregrip", "minecraft:blaze_rod", Rarity.UNCOMMON,
                "Straight up and down, like your aim now is.",
                List.of("Big recoil reduction", "Tight spread"),
                s -> s.recoil(-0.25).spread(-1.8).damage(0.5));

        add("honey_grip", PartSection.GRIP, "Honey Grip", "minecraft:honey_block", Rarity.RARE,
        ...
        add("rocket_grip", PartSection.GRIP, "Rocket Grip", "minecraft:firework_rocket", Rarity.EXOTIC,
        ...
        add("squid_grip", PartSection.GRIP, "Squid Grip", "minecraft:ink_sac", Rarity.CURSED,
        ...
        add("golden_grip", PartSection.GRIP, "Golden Grip", "minecraft:gold_ingot", Rarity.RARE,
        ...
        add("skeleton_hand", PartSection.GRIP, "Skeleton Hand Grip", "minecraft:skeleton_skull", Rarity.CURSED,
    ...
    private static void registerMagazines() {
        add("stick_mag", PartSection.MAGAZINE, "Stick Mag", "minecraft:iron_nugget", Rarity.COMMON,
                "Eight rounds. Count them. You will need to.",
                List.of("8 rounds", "Very fast reload", "Extra damage"),
                s -> s.mag(-4).reload(-12).damage(1.0));

        add("extended_mag", PartSection.MAGAZINE, "Extended Mag", "minecraft:iron_ingot", Rarity.UNCOMMON,
                "Sticks out awkwardly. Worth it.",
                List.of("+18 rounds", "Slightly slower reload"),
                s -> s.mag(18).reload(6));

        add("drum_mag", PartSection.MAGAZINE, "Drum Mag", "minecraft:cauldron", Rarity.RARE,
        ...
        add("ammo_belt", PartSection.MAGAZINE, "Ammo Belt", "minecraft:iron_chain", Rarity.EXOTIC,
        ...
        add("rocket_rack", PartSection.MAGAZINE, "Rocket Rack", "minecraft:firework_star", Rarity.EXOTIC,
        ...
        add("shell_box", PartSection.MAGAZINE, "Shell Box", "minecraft:barrel", Rarity.UNCOMMON,
        ...
        add("bottomless_satchel", PartSection.MAGAZINE, "Bottomless Satchel", "minecraft:bundle", Rarity.CURSED,
        ...
        add("nuke_mag", PartSection.MAGAZINE, "Nuke Mag", "minecraft:wither_skeleton_skull", Rarity.EXOTIC,
        ...
        add("hopper_feed", PartSection.MAGAZINE, "Hopper Feed", "minecraft:hopper", Rarity.RARE,
        ...
        add("soul_jar", PartSection.MAGAZINE, "Soul Jar Mag", "minecraft:soul_lantern", Rarity.CURSED,
    ...
    private static void registerSights() {
        add("iron_sights", PartSection.SIGHT, "Iron Sights", "minecraft:iron_bars", Rarity.COMMON,
                "A notch and a bump. It has worked for centuries.",
                List.of("Small accuracy bump", "No downsides"),
                s -> s.spread(-0.8));

        add("red_dot", PartSection.SIGHT, "Red Dot", "minecraft:redstone_torch", Rarity.COMMON,
                "Put the dot on the thing. Remove the thing.",
                List.of("Better accuracy", "Slight zoom"),
                s -> s.spread(-1.6).zoom(1));

        add("holo", PartSection.SIGHT, "Holographic Sight", "minecraft:glass_pane", Rarity.UNCOMMON,
                "A floating rectangle of pure confidence.",
                List.of("Good accuracy", "Faster handling"),
                s -> s.spread(-2.2).zoom(1).fireRate(-0.5));

        add("sniper_scope", PartSection.SIGHT, "Sniper Scope", "minecraft:spyglass", Rarity.RARE,
        ...
        add("thermal", PartSection.SIGHT, "Thermal Scope", "minecraft:magma_cream", Rarity.RARE,
        ...
        add("laser_pointer", PartSection.SIGHT, "Laser Pointer", "minecraft:end_rod", Rarity.UNCOMMON,
        ...
        add("googly_eyes", PartSection.SIGHT, "Googly Eyes", "minecraft:snowball", Rarity.CURSED,
        ...
        add("seeker_eye", PartSection.SIGHT, "Eye of the Seeker", "minecraft:ender_eye", Rarity.EXOTIC,
        ...
        add("cracked_monocle", PartSection.SIGHT, "Cracked Monocle", "minecraft:glass", Rarity.CURSED,
        ...
        add("target_computer", PartSection.SIGHT, "Target Computer", "minecraft:observer", Rarity.EXOTIC,
    ...
    private static void registerStocks() {
        add("wooden_stock", PartSection.STOCK, "Wooden Stock", "minecraft:oak_planks", Rarity.COMMON,
                "Whittled by someone who had time.",
                List.of("Balanced all round"),
                s -> s.spread(-0.8).recoil(-0.1).reload(-2));

        add("tactical_stock", PartSection.STOCK, "Tactical Stock", "minecraft:netherite_scrap", Rarity.UNCOMMON,
        ...
        add("anvil_stock", PartSection.STOCK, "Heavy Anvil Stock", "minecraft:anvil", Rarity.RARE,
        ...
        add("skeleton_stock", PartSection.STOCK, "Skeleton Stock", "minecraft:bone_block", Rarity.UNCOMMON,
        ...
        add("slime_pad", PartSection.STOCK, "Slime Pad Stock", "minecraft:slime_block", Rarity.RARE,
        ...
        add("booster_stock", PartSection.STOCK, "Rocket Booster Stock", "minecraft:fire_charge", Rarity.EXOTIC,
        ...
        add("cactus_stock", PartSection.STOCK, "Cactus Stock", "minecraft:cactus", Rarity.CURSED,
        ...
        add("cushion_stock", PartSection.STOCK, "Cushion Stock", "minecraft:white_wool", Rarity.RARE,
        ...
        add("jukebox_stock", PartSection.STOCK, "Jukebox Stock", "minecraft:jukebox", Rarity.EXOTIC,
        ...
        add("void_stock", PartSection.STOCK, "Void Stock", "minecraft:obsidian", Rarity.CURSED,
    ...
    private static void add(String id, PartSection section, String name, String icon, Rarity rarity,
                            String flavor, List<String> perks, Consumer<GunStats> apply) {
        GunPart part = new GunPart(id, section, name, icon, flavor, rarity, perks, apply);
